        ...
        <div className="prose dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              AI Agent Platform (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;, or &quot;Company&quot;) operates the website and services. 
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300">
              <li><strong>Personal Data:</strong> Email address, name, phone number, and other contact information</li>
              <li><strong>Usage Data:</strong> Browser type, IP address, pages visited, time and date of visits</li>
              <li><strong>Document Data:</strong> Files and documents uploaded for processing by our AI agents</li>
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
              <p className="text-gray-700 dark:text-gray-300">
                Email: <a href="mailto:privacy@lstech.solutions" className="text-blue-600 dark:text-blue-400 hover:underline">
